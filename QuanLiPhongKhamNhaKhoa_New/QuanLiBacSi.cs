...
namespace QuanLiPhongKhamNhaKhoa_New
{
    public partial class QuanLiBacSi : Form
    {
        ...
        {
            DataTable dataTable = bacSiBUS.LayDuLieuBacSi();
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                textBox1.Text = row.Cells["MaBS"].Value.ToString();
                textBox6.Text = row.Cells["TenBS"].Value.ToString();
        ...
        {
            ThemBacSi themBacSiForm = new ThemBacSi();
            themBacSiForm.ShowDialog();
        }
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                string maBS = selectedRow.Cells["MaBS"].Value.ToString();
                string tenBS = selectedRow.Cells["TenBS"].Value.ToString();
    ...
    /*public void AddRowToDataGridView(string maBS, string tenBS, string diaChi, DateTime ngaySinh, string sdt, string email, string gioiTinh, string calam, string matKhau, string maPhong)
{
// Thêm dữ liệu vào DataGridView
dataGridView1.Rows.Add(maBS, tenBS, diaChi, ngaySinh, sdt, email, gioiTinh, calam, matKhau, maPhong);
}*/
